    ...
    <>
      ...
      <div className="flex flex-row gap-8 items-center justify-center mt-8">
        <div className="flex flex-col gap-1">
          <img
            src="src\assets\Overwatch_League_logo.svg.png"
            className="w-sm"
          />
      ...
      <div className="flex flex-row gap-8 items-center justify-center mt-8">
        ...
        <div className="flex flex-col gap-1">
          <img src="src\assets\afo.png" className="w-sm" />
      ...
      <div className="flex flex-row gap-8 items-center justify-center mt-8">
        <div className="flex flex-col gap-1">
          <img src="src\assets\Ultimate_Wanted_3.png" className="w-sm" />
      ...
      <div className="flex flex-row gap-8 items-center justify-center mt-8">
        ...
        <div className="flex flex-col gap-1">
          <img src="src\assets\ufa2022.jpg" className="w-sm" />
      ...
      <div className="flex flex-row gap-8 items-center justify-center mt-8">
        <div className="flex flex-col gap-1">
          <img src="src\assets\owcs.png" className="w-sm" />
